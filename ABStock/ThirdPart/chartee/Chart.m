...
-(void)setBackgroundColor:(UIColor *)backgroundColor withFrame:(CGRect)_rect
{
    backGroundColor=[backgroundColor copy];
    backGroundColorFram=_rect;
}
...
//        NSLog(@"backGroundColor %@",backGroundColor);
        ...
        CGFloat red = components[0], green = components[1], blue = components[2], alpha = CGColorGetAlpha(backGroundColor.CGColor);

        CGRect rectangle = CGRectMake( backGroundColorFram.origin.x, backGroundColorFram.origin.y, backGroundColorFram.size.width ,  backGroundColorFram.size.height);
        CGContextRef context = UIGraphicsGetCurrentContext();
//        CGContextClearRect(UIGraphicsGetCurrentContext(), backGroundColorFram);
